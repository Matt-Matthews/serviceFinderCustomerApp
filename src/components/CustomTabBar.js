...
export default function CustomTabBar({ state, navigation}) {
  ...
  return (
    <View style={styles.tabBarStyles}>
      ...
      <Pressable onPress={()=>tabNavigate('Services')} >
      <LinearGradient  style={styles.btn}
      colors={tabIndex===2?['#B615DE', '#D428A8']:['#131313', '#131313']}
      start={{x: 0, y: 0}}
      end={{x: 1, y: 0}}>
        <Ionicons name='md-list-sharp' size={30} color={tabIndex===2?"white":"gray"} />
        {tabIndex===2&&<Text style={styles.text}>Services</Text>}
        </LinearGradient>
      </Pressable>
      ...
      start={{x: 0, y: 0}}
        ...
        <Ionicons name='md-notifications-sharp' size={30} color={tabIndex===3?"white":"gray"} />
        {tabIndex===3&&<Text style={styles.text}>Notifications</Text>}
        </LinearGradient>
      </Pressable>

      <Pressable onPress={()=>tabNavigate('Settings')} >
      <LinearGradient  style={styles.btn}
      colors={tabIndex===4?['#B615DE', '#D428A8']:['#131313', '#131313']}
      start={{x: 0, y: 0}}
      end={{x: 1, y: 0}}>
        <Ionicons name='md-settings-sharp' size={30} color={tabIndex===4?"white":"gray"} />
        {tabIndex===4&&<Text style={styles.text}>Settings</Text>}
        </LinearGradient>
      </Pressable>
    </View>
  );
